...
@Tags(value = {@Tag(AnnotationValues.REGRESSION_TAG),@Tag(AnnotationValues.HEALTH_CHECK_TAG)})
...
public class GetHealthCheck {
    ...
    @Test
    @DisplayName("Health check")
    @Description("GET health check to confirm whether the API is up and running")
    @Feature("GET health check")
    public void getHealthCheck() {
        Response response = bookingSteps.getHealthCheck();
